"""
    GRU RNN for climate forecasting
    Added also reccurent drop outs
    Validation error of about 0.25 to 0.26 but does not rise with epochs
"""
...
# Preparing train, val and test generators
lookback = 1440
step = 6
delay = 144
batch_size = 128
